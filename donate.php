...
<header>
        <nav>
            ...
            <h1><label class="head"></label>
                ...
                <li style="padding-right:60px;">
                    ...
                    <ul><a href="tel:+27 78 973 1952"><span class="ml-1">CONTACT US</span></a></ul>
                </li>
            </h1>
        </nav>
    </header>
    ...
    <h2 style="text-align:center">Help us help students</h2>
    <div id="row1">
        <div id="gallary">
            <img src="images/carport1.jpg" height="200px" width="300px" alt="Your Company info">
            <p style="color:black; background-color: white; padding: 5px;">Company Information</p>
        </div>
        <div id="gallary">
            <img src="images/carport2.jpg" height="200px" width="300px" alt="Bank">
            <p style="color:black; background-color: white; padding: 5px;">Banking Details</p>
        </div>
    </div>
    <br><br><br>
