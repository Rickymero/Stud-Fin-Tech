...
<body>
    <header>
        <nav>
            ...
            <h1><label class="head"></label>
                ...
                <li>
                    <ul><a href="index.php"><!--<i class="fa-brands fa-envira"></i>-->&nbsp;HOME</a></ul>
                    <ul><a href=""><!--<i class="fa-solid fa-blender-phone"></i>-->&nbsp;DONATE</a></ul>
    ...
    <br /><br />
    <center>
    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLScCnKfmEng-vecxKRc7tBuzvZdC7zX1bAju3TnVXAOhYAj5HQ/viewform?embedded=true" 
        width="640" height="600" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
    </center>
